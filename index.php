...
<head>
   ...
   <title>Online clothes management system</title>
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>C</span>lothe.</a>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/cloth10.jpg" alt="">
            </div>
            <div class="content">
               <h3>cloth 1</h3>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Get your your item at a good time</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Share our experience with your friends, families</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         <p class="accrodion-content">
            This is an online shopping management system, busy an item online and get it at your place.
         </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
            It may takes up to 1 day, no more time than this.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>can I order for clothe of wedding?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Yes, just you have to make your order in a section order
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>mankunkujeanpierre@@gmail.com</p>
         <p>patientmwenge@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Mankunku</span> | all rights reserved!
   </div>
